...
class _PaginaPrincipalState extends State<PaginaPrincipal> {
  ...
  Widget mostrarAppBar() {
    return AppBar(
      backgroundColor: Color.fromARGB(255, 109, 111, 204),
      elevation: 0,
      title: Padding(
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          ...
          border: Border.all(width: 3,color: Color.fromARGB(255, 198, 207, 223),style: BorderStyle.solid)),
                              ...
                              child: Text(
                                ...
                                style: TextStyle(
                                    ...
                                    color: activoMenu1 == index
                                        ? Color.fromARGB(213, 43, 86, 165)
                                        : Color.fromARGB(255, 255, 255, 255),
                                        backgroundColor: Color.fromARGB(255, 198, 207, 223),
                            ...
                            activoMenu1 == index
                                ? Container(
                                    ...
                                    height: 3,
                                    decoration: BoxDecoration(
                                        color: Color.fromARGB(255, 1, 47, 255),
           ...
           Padding(
                    ...
                    child: Container(
                          ...
                          child: Text("Animales",style: TextStyle(height: 5, fontSize: 25,color: Color.fromARGB(255, 94, 101, 163)),
                          ),
                        ),
                  ),
          SizedBox(
